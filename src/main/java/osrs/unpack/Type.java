...
public enum Type {
    ...
    ONSHIFTCLICKNPC(-1, 0, BaseVarType.INTEGER),
    ONSHIFTCLICKLOC(-1, 0, BaseVarType.INTEGER),
    ONSHIFTCLICKOBJ(-1, 0, BaseVarType.INTEGER),
    ONSHIFTCLICKPLAYER(-1, 0, BaseVarType.INTEGER),
    ONSHIFTCLICKTILE(-1, 0, BaseVarType.INTEGER),
