...
public enum Type {
    ...
    ONCLIENTOPNPC(-1, 0, BaseVarType.INTEGER),
    ONCLIENTOPLOC(-1, 0, BaseVarType.INTEGER),
    ONCLIENTOPOBJ(-1, 0, BaseVarType.INTEGER),
    ONCLIENTOPPLAYER(-1, 0, BaseVarType.INTEGER),
    ONCLIENTOPTILE(-1, 0, BaseVarType.INTEGER),
